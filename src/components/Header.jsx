...
const Header = () => {
    ...
    return (
        <div className='px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 shadow border-2 border-gray-50'>
            <div className='relative flex items-center justify-between'>
                ...
                >
                    <div className='flex items-center justify-center w-12 h-12 rounded-full bg-purple-300'>
